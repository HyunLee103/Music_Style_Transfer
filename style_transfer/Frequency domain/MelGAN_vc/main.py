...
parser.add_argument("--g_lr", default=1e-4, type=float, dest="g_lr")
parser.add_argument("--d_lr", default=1e-4, type=float, dest="d_lr")
...
parser.add_argument("--gupt", default=3 , type=int, dest="gupt")
